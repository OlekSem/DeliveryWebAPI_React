...
const navItems: NavItem[] = [
    {
        ...
        subItems: [
            ...
            {name: "Countries", path: "/admin/countries", pro: false},
            {name: "Cities", path: "/admin/cities", pro: false},
            {name: "Create country", path: "/admin/create/country", pro: false},
            {name: "Create city", path: "/admin/create/city", pro: false}
        ],
    },
    {
        icon: <CalenderIcon/>,
